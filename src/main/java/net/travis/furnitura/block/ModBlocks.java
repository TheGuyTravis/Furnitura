...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> OAK_SHELF = registerBlock("oak_shelf", () -> new ShelfBlock(Block.Properties.copy(Blocks.OAK_PLANKS), ShelfBlock.MaterialType.OAK));
    ...
    public static final RegistryObject<Block> BIRCH_CHAIR = registerBlock("birch_chair", () -> new ChairBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> JUNGLE_SHELF = registerBlock("jungle_shelf", () -> new ShelfBlock(Block.Properties.copy(Blocks.JUNGLE_PLANKS), ShelfBlock.MaterialType.JUNGLE));
    ...
    public static final RegistryObject<Block> MANGROVE_SHELF = registerBlock("mangrove_shelf", () -> new ShelfBlock(Block.Properties.copy(Blocks.MANGROVE_PLANKS), ShelfBlock.MaterialType.MANGROVE));
    ...
    public static final RegistryObject<Block> CHERRY_SHELF = registerBlock("cherry_shelf", () -> new ShelfBlock(Block.Properties.copy(Blocks.CHERRY_PLANKS), ShelfBlock.MaterialType.CHERRY));
    ...
    public static final RegistryObject<Block> CRIMSON_SHELF = registerBlock("crimson_shelf", () -> new ShelfBlock(Block.Properties.copy(Blocks.CRIMSON_PLANKS), ShelfBlock.MaterialType.CRIMSON));
    ...
    public static final RegistryObject<Block> WARPED_SHELF = registerBlock("warped_shelf", () -> new ShelfBlock(Block.Properties.copy(Blocks.WARPED_PLANKS), ShelfBlock.MaterialType.WARPED));
    ...
    public static final RegistryObject<Block> DARK_OAK_SHELF = registerBlock("dark_oak_shelf", () -> new ShelfBlock(Block.Properties.copy(Blocks.DARK_OAK_PLANKS), ShelfBlock.MaterialType.DARK_OAK));
    ...
    public static final RegistryObject<Block> ACACIA_SHELF = registerBlock("acacia_shelf", () -> new ShelfBlock(Block.Properties.copy(Blocks.ACACIA_PLANKS), ShelfBlock.MaterialType.ACACIA));
    ...
    public static final RegistryObject<Block> SPRUCE_SHELF = registerBlock("spruce_shelf", () -> new ShelfBlock(Block.Properties.copy(Blocks.SPRUCE_PLANKS), ShelfBlock.MaterialType.SPRUCE));
    public static final RegistryObject<Block> BIRCH_SHELF = registerBlock("birch_shelf", () -> new ShelfBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS), ShelfBlock.MaterialType.BIRCH));
    ...
    public static final RegistryObject<Block> BIRCH_CABINET = registerBlock("birch_cabinet", () -> new CabinetBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).noOcclusion()));
    ...
    public static final RegistryObject<Block> BIRCH_TABLE = registerBlock("birch_table", () -> new TableBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).noOcclusion()));
    ...
    public static final RegistryObject<Block> SMALL_TABLE_OAK = registerBlock("small_table_oak", () -> new SmallTableBlock(Block.Properties.copy(Blocks.OAK_PLANKS), SmallTableBlock.MaterialType.OAK));
    public static final RegistryObject<Block> SMALL_TABLE_JUNGLE = registerBlock("small_table_jungle", () -> new SmallTableBlock(Block.Properties.copy(Blocks.JUNGLE_PLANKS), SmallTableBlock.MaterialType.OAK));
    public static final RegistryObject<Block> SMALL_TABLE_MANGROVE = registerBlock("small_table_mangrove", () -> new SmallTableBlock(Block.Properties.copy(Blocks.MANGROVE_PLANKS), SmallTableBlock.MaterialType.OAK));
    public static final RegistryObject<Block> SMALL_TABLE_CHERRY = registerBlock("small_table_cherry", () -> new SmallTableBlock(Block.Properties.copy(Blocks.CHERRY_PLANKS), SmallTableBlock.MaterialType.OAK));
    public static final RegistryObject<Block> SMALL_TABLE_CRIMSON = registerBlock("small_table_crimson", () -> new SmallTableBlock(Block.Properties.copy(Blocks.CRIMSON_PLANKS), SmallTableBlock.MaterialType.OAK));
    public static final RegistryObject<Block> SMALL_TABLE_WARPED = registerBlock("small_table_warped", () -> new SmallTableBlock(Block.Properties.copy(Blocks.WARPED_PLANKS), SmallTableBlock.MaterialType.OAK));
    public static final RegistryObject<Block> SMALL_TABLE_DARK_OAK = registerBlock("small_table_dark_oak", () -> new SmallTableBlock(Block.Properties.copy(Blocks.DARK_OAK_PLANKS), SmallTableBlock.MaterialType.OAK));
    public static final RegistryObject<Block> SMALL_TABLE_ACACIA = registerBlock("small_table_acacia", () -> new SmallTableBlock(Block.Properties.copy(Blocks.ACACIA_PLANKS), SmallTableBlock.MaterialType.OAK));
    public static final RegistryObject<Block> SMALL_TABLE_SPRUCE = registerBlock("small_table_spruce", () -> new SmallTableBlock(Block.Properties.copy(Blocks.SPRUCE_PLANKS), SmallTableBlock.MaterialType.OAK));
    public static final RegistryObject<Block> SMALL_TABLE_BIRCH = registerBlock("small_table_birch", () -> new SmallTableBlock(Block.Properties.copy(Blocks.BIRCH_PLANKS), SmallTableBlock.MaterialType.BIRCH));
    ...
    public static final RegistryObject<Block> BIRCH_LOG_SHELF = registerBlock("birch_log_shelf", () -> new LogShelfBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).noOcclusion()));
    ...
    public static final RegistryObject<Block> SINGLE_LEG_TABLE_BIRCH = registerBlock("single_leg_table_birch", () -> new SingleLegTableBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).noOcclusion()));
    ...
    public static final RegistryObject<Block> BIRCH_STUMP = registerBlock("birch_stump", () -> new StumpBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).noOcclusion()));
    ...
    public static final RegistryObject<Block> JUNGLE_CRATE = registerBlock("jungle_crate", () -> new CrateBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> MANGROVE_CRATE = registerBlock("mangrove_crate", () -> new CrateBlock(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> CRIMSON_CRATE = registerBlock("crimson_crate", () -> new CrateBlock(BlockBehaviour.Properties.copy(Blocks.CRIMSON_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> WARPED_CRATE = registerBlock("warped_crate", () -> new CrateBlock(BlockBehaviour.Properties.copy(Blocks.WARPED_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> DARK_OAK_CRATE = registerBlock("dark_oak_crate", () -> new CrateBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> ACACIA_CRATE = registerBlock("acacia_crate", () -> new CrateBlock(BlockBehaviour.Properties.copy(Blocks.ACACIA_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> SPRUCE_CRATE = registerBlock("spruce_crate", () -> new CrateBlock(BlockBehaviour.Properties.copy(Blocks.SPRUCE_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> BIRCH_CRATE = registerBlock("birch_crate", () -> new CrateBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).noOcclusion()));
    ...
    public static final RegistryObject<Block> OAK_MAILBOX = registerBlock("oak_mailbox", () -> new MailBoxBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> JUNGLE_MAILBOX = registerBlock("jungle_mailbox", () -> new MailBoxBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> MANGROVE_MAILBOX = registerBlock("mangrove_mailbox", () -> new MailBoxBlock(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> CHERRY_MAILBOX = registerBlock("cherry_mailbox", () -> new MailBoxBlock(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> CRIMSON_MAILBOX = registerBlock("crimson_mailbox", () -> new MailBoxBlock(BlockBehaviour.Properties.copy(Blocks.CRIMSON_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> WARPED_MAILBOX = registerBlock("warped_mailbox", () -> new MailBoxBlock(BlockBehaviour.Properties.copy(Blocks.WARPED_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> DARK_OAK_MAILBOX = registerBlock("dark_oak_mailbox", () -> new MailBoxBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> ACACIA_MAILBOX = registerBlock("acacia_mailbox", () -> new MailBoxBlock(BlockBehaviour.Properties.copy(Blocks.ACACIA_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> SPRUCE_MAILBOX = registerBlock("spruce_mailbox", () -> new MailBoxBlock(BlockBehaviour.Properties.copy(Blocks.SPRUCE_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> BIRCH_MAILBOX = registerBlock("birch_mailbox", () -> new MailBoxBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> OAK_STOOL = registerBlock("oak_stool", () -> new StoolBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> JUNGLE_STOOL = registerBlock("jungle_stool", () -> new StoolBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> MANGROVE_STOOL = registerBlock("mangrove_stool", () -> new StoolBlock(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> CHERRY_STOOL = registerBlock("cherry_stool", () -> new StoolBlock(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> CRIMSON_STOOL = registerBlock("crimson_stool", () -> new StoolBlock(BlockBehaviour.Properties.copy(Blocks.CRIMSON_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> WARPED_STOOL = registerBlock("warped_stool", () -> new StoolBlock(BlockBehaviour.Properties.copy(Blocks.WARPED_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> DARK_OAK_STOOL = registerBlock("dark_oak_stool", () -> new StoolBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> ACACIA_STOOL = registerBlock("acacia_stool", () -> new StoolBlock(BlockBehaviour.Properties.copy(Blocks.ACACIA_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> SPRUCE_STOOL = registerBlock("spruce_stool", () -> new StoolBlock(BlockBehaviour.Properties.copy(Blocks.SPRUCE_PLANKS).noOcclusion()));
    public static final RegistryObject<Block> BIRCH_STOOL = registerBlock("birch_stool", () -> new StoolBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).noOcclusion()));
