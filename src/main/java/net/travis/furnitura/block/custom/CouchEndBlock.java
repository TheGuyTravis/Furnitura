...
public class CouchEndBlock extends FurnitureHorizontalBlock
{
    public final ImmutableMap<BlockState, VoxelShape> SHAPES;

    public CouchEndBlock(Properties properties)
    {
        super(properties);
    ...
    {
        final VoxelShape[] SHAPE_ONE = VoxelShapeHelper.getRotatedShapes(VoxelShapeHelper.rotate(Block.box(1, 4, 2, 16, 6, 11), Direction.NORTH));
        final VoxelShape[] SHAPE_TWO = VoxelShapeHelper.getRotatedShapes(VoxelShapeHelper.rotate(Block.box(1, 4, 0, 16, 16, 2), Direction.NORTH));
        final VoxelShape[] SHAPE_THREE = VoxelShapeHelper.getRotatedShapes(VoxelShapeHelper.rotate(Block.box(1, 2, 2, 3, 4, 9), Direction.NORTH));
        ...
        final VoxelShape[] SHAPE_FIVE = VoxelShapeHelper.getRotatedShapes(VoxelShapeHelper.rotate(Block.box(3, 2, 0, 14, 4, 2), Direction.NORTH));
        final VoxelShape[] SHAPE_SIX = VoxelShapeHelper.getRotatedShapes(VoxelShapeHelper.rotate(Block.box(3, 2, 9, 14, 4, 11), Direction.NORTH));
        final VoxelShape[] SHAPE_SEVEN = VoxelShapeHelper.getRotatedShapes(VoxelShapeHelper.rotate(Block.box(1, 0, 9, 3, 4, 11), Direction.NORTH));
        ...
        final VoxelShape[] SHAPE_NINE = VoxelShapeHelper.getRotatedShapes(VoxelShapeHelper.rotate(Block.box(1, 0, 0, 3, 4, 2), Direction.NORTH));
        ...
        final VoxelShape[] SHAPE_ELEVEN = VoxelShapeHelper.getRotatedShapes(VoxelShapeHelper.rotate(Block.box(0, 6, 2, 2, 9, 12), Direction.NORTH));
