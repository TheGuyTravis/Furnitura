...
import net.travis.furnitura.block.custom.CabinetBlock;
...
public class CrateBlockEntity extends RandomizableContainerBlockEntity {
    ...
    protected CrateBlockEntity(BlockEntityType<?> pType, BlockPos pPos, BlockState pBlockState) {
    ...
    protected Component getDefaultName() {
        return Component.translatable("container.furnitura.crate");
    }
    ...
    void updateBlockState(BlockState pState, boolean pOpen) {
        this.level.setBlock(this.getBlockPos(), pState.setValue(CabinetBlock.OPEN, Boolean.valueOf(pOpen)), 3);
    }
